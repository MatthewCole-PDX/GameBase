...
const pool = new Pool({
  connectionString: "postgres://sajfopicqfjqpa:0207c07d082bbe7f11ebc9fe5e8dafb13796b05c0ea7a336d47ba14ecd57bef4@ec2-52-207-124-89.compute-1.amazonaws.com:5432/dc1qe778cvpm8r",
  ssl: {
...
app.post("/search", async (req, res) => {
  res.status(200);
  var results = ("Searching for " + req.body.searchFor + " in " + req.body.category + "\n" + "\n");
  try {
    const client = await pool.connect();
    const result = await client.query('SELECT name FROM ' + req.body.category + 'WHERE name LIKE ' + req.body.searchFor +';');
